...
// #include <math.h>
// #include <time.h>
// #include<quadrotor_msgs/msg/aux_commaand.h>
#include <traj_utils/planning_visualization.h>

#include <rosa/datawrapper.h>
#include <rosa/Extra_Del.h>

#include <rclcpp/rclcpp.hpp>  // ROS2 的节点管理
#include <pcl/io/pcd_io.h>
#include <pcl/point_types.h>
#include <pcl/kdtree/kdtree_flann.h>
#include <pcl/common/common.h>
...
private:
  ...
  /* Data */
  std::string input_pcd, input_mesh;
  int pcd_size_;
  int seg_count;
  double norm_scale;
  Eigen::MatrixXd MAHADJ;
  ...
  std::vector<int> merge_branch(std::vector<int>& input_branch);
  bool prune(std::vector<int>& input_branch);
  double distance_point_line(Eigen::Vector3d& point, Eigen::Vector3d& line_pt, Eigen::Vector3d& line_dir);
  Eigen::Vector3d PCA(Eigen::MatrixXd& A);
  /* Timer */
