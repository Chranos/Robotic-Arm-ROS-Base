                      ...
                      std::vector<uint8_t> &output)
{
  ...
  so3_cmd_input.krl[0] = so3_command.krl[0]*50;
  so3_cmd_input.krl[1] = so3_command.krl[1]*50;
  so3_cmd_input.krl[2] = so3_command.krl[2]*50;
  ...
  so3_cmd_input.kolm[0] = so3_command.kolm[0]*100;
  so3_cmd_input.kolm[1] = so3_command.kolm[1]*100;
  so3_cmd_input.kolm[2] = so3_command.kolm[2]*100;
                    ...
                    std::vector<uint8_t> &output)
{
  ...
  ppr_gains.klp = gains.klp;
  ppr_gains.kld = gains.kld;
  ppr_gains.klp_yaw = gains.klp_yaw;
  ppr_gains.kld_yaw = gains.kld_yaw;
