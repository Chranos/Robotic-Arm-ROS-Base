...
void PerceptionUtils::init(rclcpp::Node::SharedPtr node)
{
  // * Params Initialization
  node->get_parameter_or("perception_utils/top_angle", top_angle_, -1.0);
  node->get_parameter_or("perception_utils/left_angle", left_angle_, -1.0);
  node->get_parameter_or("perception_utils/right_angle", right_angle_, -1.0);

  node->get_parameter_or("perception_utils/max_dist", max_dist_, -1.0);
  node->get_parameter_or("perception_utils/vis_dist", vis_dist_, -1.0);
