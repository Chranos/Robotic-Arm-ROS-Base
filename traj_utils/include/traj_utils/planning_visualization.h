...
//  ros::NodeHandle node;
  ...
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr viewpoint_pub_;
  ...
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pred_pub_;       // 7, prediction point cloud
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr localReg_pub_;   // 8. local region point cloud
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr global_pub_;     // 9, global planning tour
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr vpg_pub_;        // 10, global planning viewpoints
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr internal_pub_;   // 11, global prediction internal
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr global_dir_pub_; // 12, global direction
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr global_c_pub_;   // 13, global cluster
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr global_n_pub_;   // 14, global normals
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr local_pub_;      // 15, local planning tour
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr localob_pub_;    // 15_1, local planning tour
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr localVP_pub_;    // 16, local planning viewpoints
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr normal_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr rosa_orientation_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr drosa_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr le_pts_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr le_lines_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr rr_pts_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr rr_lines_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr decomp_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr branch_start_end_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr branch_dir_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr cut_plane_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr cut_pt_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr sub_space_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr sub_endpts_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr vertex_ID_pub_;
  ...
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr checkPoint_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr checkNeigh_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr checkCPdir_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr checkRP_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr checkCPpts_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr checkCPptsCluster_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr checkBranch_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr checkAdj_pub_;

  // ROSA Opt
 // ros::Publisher optArea_pub_;

  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr optArea_pub_;
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr init_vps_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr sub_vps_hull_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr before_opt_vp_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr after_opt_vp_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr hcopp_viewpoints_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr hcopp_occ_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr hcopp_internal_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr hcopp_fov_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr hcopp_uncovered_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_validvp_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_correctnormal_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_sub_finalvps_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_vps_drone_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_globalseq_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_globalboundary_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_local_path_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcopp_full_path_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr fullatsp_full_path_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr fullgdcpca_full_path_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pca_vec_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr cylinder_pub_;
  rclcpp::Publisher<quadrotor_msgs::msg::PolynomialTraj>::SharedPtr posi_traj_pub_, pitch_traj_pub_, yaw_traj_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr jointSphere_pub_;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr hcoppYaw_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pathVisible_pub_;

  // Updates Visualization
  // ros::Publisher currentPose_pub_;
  // ros::Publisher currentVoxels_pub_;

  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr currentPose_pub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr currentVoxels_pub_;
  ...
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr drawFoV_pub_;
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr drone_pub_;
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr traveltraj_pub_;
  ...
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr visible_pub_;
...
public:
  ...
  // }
  PlanningVisualization(const std::shared_ptr<rclcpp::Node>& nh);
  ...
  void publishHCOPPTraj(quadrotor_msgs::msg::PolynomialTraj& posi, quadrotor_msgs::msg::PolynomialTraj& pitch, quadrotor_msgs::msg::PolynomialTraj& yaw);
